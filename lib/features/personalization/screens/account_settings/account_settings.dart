                    ...
                    children: [
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () {
                            // Handle the tap event for changing profile picture
                            print('Change Profile Picture tapped');
                            // TODO: Implement actual image picker logic here (e.g., from gallery/camera)
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Image picker functionality not implemented yet.')),
                            );
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.white, // Changed button color to blue (as per previous request)
