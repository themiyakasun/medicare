...
import 'package:medicare/features/doctor/screens/appointments/appointments.dart';
import 'package:medicare/features/doctor/screens/availability/availability.dart';
...
class NavigationMenuDoctor extends StatefulWidget {
  const NavigationMenuDoctor({super.key});

  @override
  State<NavigationMenuDoctor> createState() => _NavigationMenuDoctorState();
}

class _NavigationMenuDoctorState extends State<NavigationMenuDoctor> {
